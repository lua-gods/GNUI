...
---@param units number?
---@return GNUI.Sprite
function Sprite:setBorderTop(units)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setBorderLeft(units)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setBorderBottom(units)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setBorderRight(units)
...
---@return GNUI.Sprite
function Sprite:setExpand(left,top,right,bottom)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setExpandTop(units)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setExpandLeft(units)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setExpandBottom(units)
...
---@param units number?
---@return GNUI.Sprite
function Sprite:setExpandRight(units)
...
function Sprite:setDepthOffset(offset_units)
